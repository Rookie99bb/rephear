...
export function findPendingRequestForUser(
...
export function createClaimRequest(params: {
  applicantUserId: string;
  profileId: string;
  linkedinUrl: string;
  ...
  return findClaimRequestById(id)!;
}

export function findClaimRequestById(id: string): ClaimRequest | null {
  const row = db
...
export function listClaimRequestsByStatus(
...
export function approveClaimRequest(params: {
  id: string;
  reviewedBy: string;
...
export function rejectClaimRequest(params: {
  id: string;
  reviewedBy: string;
  adminComments: string;
  reviewedAt?: string;
...
export function rejectOtherPendingRequestsForProfile(params: {
  profileId: string;
